...
{
    public class ProcPagedListRenderOptions
    {
        ///<summary>
		/// The default settings render all navigation links and no descriptive text.
		///</summary>
		public ProcPagedListRenderOptions()
		{
			DisplayLinkToFirstPage = ProcPagedListDisplayMode.IfNeeded;
			DisplayLinkToLastPage = ProcPagedListDisplayMode.IfNeeded;
			DisplayLinkToPreviousPage = ProcPagedListDisplayMode.IfNeeded;
			DisplayLinkToNextPage = ProcPagedListDisplayMode.IfNeeded;
        ...
        /// </summary>
        public ProcPagedListDisplayMode Display { get; set; }
		...
		///</summary>
		public ProcPagedListDisplayMode DisplayLinkToFirstPage { get; set; }
		...
		///</summary>
        public ProcPagedListDisplayMode DisplayLinkToLastPage { get; set; }
		...
		///</summary>
        public ProcPagedListDisplayMode DisplayLinkToPreviousPage { get; set; }
		...
		///</summary>
        public ProcPagedListDisplayMode DisplayLinkToNextPage { get; set; }
		...
		/// <returns>The ProcPagedListRenderOptions value passed in, with unobtrusive AJAX attributes added to the page links.</returns>
        public static ProcPagedListRenderOptions EnableUnobtrusiveAjaxReplacing(ProcPagedListRenderOptions options, AjaxOptions ajaxOptions)
		{
		...
		/// <returns>A default instance of ProcPagedListRenderOptions value passed in, with unobtrusive AJAX attributes added to the page links.</returns>
		public static ProcPagedListRenderOptions EnableUnobtrusiveAjaxReplacing(string id)
		{
            ...
            return EnableUnobtrusiveAjaxReplacing(new ProcPagedListRenderOptions(), ajaxOptions);
		}
        ...
        /// <returns>A default instance of ProcPagedListRenderOptions value passed in, with unobtrusive AJAX attributes added to the page links.</returns>
        public static ProcPagedListRenderOptions EnableUnobtrusiveAjaxReplacing(AjaxOptions ajaxOptions)
        {
            return EnableUnobtrusiveAjaxReplacing(new ProcPagedListRenderOptions(), ajaxOptions);
        }
        ...
        ///</summary>
        public static ProcPagedListRenderOptions Classic
        {
            get
            {
                return new ProcPagedListRenderOptions
                {
                    DisplayLinkToFirstPage = ProcPagedListDisplayMode.Never,
                    DisplayLinkToLastPage = ProcPagedListDisplayMode.Never,
                    DisplayLinkToPreviousPage = ProcPagedListDisplayMode.Always,
                    DisplayLinkToNextPage = ProcPagedListDisplayMode.Always
                };
            }
        }
		...
		/// Also includes links to First and Last pages.
		///</summary>
		public static ProcPagedListRenderOptions ClassicPlusFirstAndLast
		{
			get
			{
				return new ProcPagedListRenderOptions
				{
					DisplayLinkToFirstPage = ProcPagedListDisplayMode.Always,
					DisplayLinkToLastPage = ProcPagedListDisplayMode.Always,
                    DisplayLinkToPreviousPage = ProcPagedListDisplayMode.Always,
                    DisplayLinkToNextPage = ProcPagedListDisplayMode.Always
				};
			}
		...
		///</summary>
		public static ProcPagedListRenderOptions Minimal
		{
			get
			{
				return new ProcPagedListRenderOptions
		...
		///</summary>
		public static ProcPagedListRenderOptions MinimalWithPageCountText
		{
			get
			{
				return new ProcPagedListRenderOptions
		...
		///</summary>
		public static ProcPagedListRenderOptions MinimalWithItemCountText
		{
			get
			{
				return new ProcPagedListRenderOptions
		...
		///</summary>
		public static ProcPagedListRenderOptions PageNumbersOnly
		{
			get
			{
				return new ProcPagedListRenderOptions
				       	{
				       		DisplayLinkToFirstPage = ProcPagedListDisplayMode.Never,
				       		DisplayLinkToLastPage = ProcPagedListDisplayMode.Never,
				       		DisplayLinkToPreviousPage = ProcPagedListDisplayMode.Never,
				       		DisplayLinkToNextPage = ProcPagedListDisplayMode.Never,
		...
		///</summary>
		public static ProcPagedListRenderOptions OnlyShowFivePagesAtATime
		{
			get
			{
				return new ProcPagedListRenderOptions
		...
		///</summary>
		public static ProcPagedListRenderOptions TwitterBootstrapPager
		{
			get
			{
				return new ProcPagedListRenderOptions
		...
		///</summary>
		public static ProcPagedListRenderOptions TwitterBootstrapPagerAligned
		{
			get
			{
				return new ProcPagedListRenderOptions
