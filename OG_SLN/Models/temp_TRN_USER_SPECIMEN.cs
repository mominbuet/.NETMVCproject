...
namespace OG_SLN
{
    public class temp_TRN_USER_SPECIMEN
    {
        ...
        public temp_TRN_USER_SPECIMEN(decimal user_spec_no, decimal? active, DateTime assignDate, DateTime? targetDateFrom, DateTime? targetDateTo, decimal userNo)
        {
