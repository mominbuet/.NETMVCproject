	...
	init:function(setting){
		...
		function buildmenu($anchors){
			$anchors.each(function(){ //loop through anchor links
				...
				$submenu.wrap('<div class="subwrapper" style="z-index:'+ddiconmenu.startzindex+';position:absolute;top:0;right:0;visibility:hidden"><div style="position:absolute;overflow:hidden;right:0;top:0;width:100%;height:100%;"></div></div>')
